...
import { Avatar, FormControl, InputLabel, MenuItem, Select, Slider } from "@mui/material";
...
return (
  ...
  <form onSubmit={(e) => handleSubmit(e)}>
    ...
    <CardBody className="flex flex-col gap-4">
      ...
      <div>
        <Input readOnly className="bg-gray-100 cursor-pointer"    value={betData?.op_bet} type="number" label={`Opponent Bet Amount In ${nativeCurrency.symbol}`} />
      </div>
      <div className="flex justify-between items-center my-4">
